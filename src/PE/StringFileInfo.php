 ...
 * StringFileInfo
 */
class StringFileInfo implements CommonPack
{
    public const SIGNATURE = "StringFileInfo\0";
    ...
    public int $type;
    #[PackItem(offset: 0x06, type: 'char[30]')]
    public string $key;
    ...
    public function unpack(string $remaining): int
    {
        ...
        while ($parsed < $this->length) {
            // printf("StringTable at 0x%x\n", $parsed);
            $child = new StringTable($parsed);
