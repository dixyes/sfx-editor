...
class COFFOptHeader64 implements CommonPack
{
    ...
    public int $magic; // 0x20b IMAGE_NT_OPTIONAL_HDR64_MAGIC
    ...
    #[PackItem(offset: 0x48, type: "uint64")]
    public int $sizeOfStackReserve;
    #[PackItem(offset: 0x50, type: "uint64")]
    public int $sizeOfStackCommit;
    #[PackItem(offset: 0x58, type: "uint64")]
    public int $sizeOfHeapReserve;
    #[PackItem(offset: 0x60, type: "uint64")]
    public int $sizeOfHeapCommit;
    #[PackItem(offset: 0x68, type: "uint32")]
    public int $loaderFlags;
    #[PackItem(offset: 0x6c, type: "uint32")]
    public int $numberOfRvaAndSizes;
    #[PackItem(offset: 0x70, type: 'DataDirectory[$this->numberOfRvaAndSizes]')]
